...
@WebServlet("/ChangeInformationPage")
public class ChangeInformationPage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ChangeInformationPage() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		PageInfo.prepareAndForward(request, response, PageType.ACCOUNT_CHANGE_INFORMATION_PAGE);
	}
